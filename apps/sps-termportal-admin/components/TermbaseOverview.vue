        ...
        <div class="p-2 space-y-3 max-w-4xl">
          ...
          <dl class="flex space-x-12">
            ...
            <div>
              ...
              <div
                v-if="slotProps.data?.descriptions"
                class="flex space-x-5"
              >
                <dt class="font-semibold w-36">
                  Beskrivelse sjekket
          ...
          <div
            ...
            class="content-page"
          >
            <h2 class="text-xl my-1 font-semibold">
              Merknad
            </h2>
          ...
          <div v-if="slotProps.data.lastActivity">
            ...
            >
              <h3 class="text-lg font-semibold">
                ...
                <span v-if="slotProps.data.lastActivity.timespan">({{ slotProps.data.lastActivity.timespan.edtf }})</span>
              </h3>
            </AppLink>
