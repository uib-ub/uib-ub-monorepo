...
export const roundButtonStyling = "inline-flex items-center justify-center aspect-square shrink-0 rounded-full bg-white text-neutral-900 leading-none p-2 lg:p-3" +
