...
export default function CollapsibleHeading(props: {
  ...
  return <div className="">
    <h3 className="!mt-0"><button className="text-left w-full text-neutral-900 flex items-center gap-1" aria-expanded={open} aria-controls={props.title + '-collapsible'} onClick={() => setOpen(!open)}>
