            ...
            >
                {(!isMobile || (!results && !mapSettings) || mode == 'table') && <LeftWindow>
                    ...
                    {(tableOptions && <TableOptions />)
                        ...
                        || (facet && <div className="w-full flex items-center px-2 xl:px-0 h-12 gap-2 xl:pl-2">
