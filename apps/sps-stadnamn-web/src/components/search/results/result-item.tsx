...
export default function ResultItem({hit, isMobile}: {hit: any, isMobile: boolean}) {
    ...
    return  <li className="flex flex-grow">
            <Link ref={itemRef} className="w-full h-full py-2 px-2 md:px-2 hover:bg-neutral-50 no-underline decoration-accent-700 aria-[current='page']:bg-accent-100 aria-[current='page']:underline" 
