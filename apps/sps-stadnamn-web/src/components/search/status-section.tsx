...
export default function StatusSection() {
    ...
    {false && datasetTag != 'base' && !isMobile && <ModeSelector/>}
    
    
    { !isMobile && <div className={`flex flex-wrap ${datasetTag == 'base' ? 'my-2': 'py-1'} xl:flex-row h-full xl:py-0 gap-2`}><ActiveFilters/> </div> }
