...
import { PiBookOpenFill, PiBookOpenLight, PiCardsFill, PiCardsLight, PiCaretLeftBold, PiListBullets, PiListBulletsFill, PiListBulletsLight, PiListLight } from "react-icons/pi";
  ...
  return <>
    ...
    {(groupTotal?.value == 1 || groupLoading || groupData?.[0]?._source?.group.id == docData?._source?.group?.id || true) ? <>
      ...
      <Clickable
        ...
        {details == "doc" ? <PiCardsFill className="text-accent-800" aria-hidden="true" /> : <PiCardsLight className="text-neutral-900" aria-hidden="true" />}
      ...
      {(groupTotal?.value && groupTotal.value > 1 || groupStatus != 'success' || true) && <Clickable
        ...
        {details == "group" ? <PiListBulletsFill className="text-accent-800" aria-hidden="true" /> : <PiListBullets className="text-neutral-900" aria-hidden="true" />}
