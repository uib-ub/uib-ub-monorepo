...
export default function AdmInfo({ hit }: { hit: any }) {
  ...
  const adm1 = (useGroupAdm && (groupAdm1 || directAdm1)) || directAdm1;
  let adm2 = (useGroupAdm && (groupAdm2 || directAdm2)) || directAdm2;

  if (!adm1 && !adm2) return null;

  if (adm2 === adm1) adm2 = undefined;

  const isAdm1FromGroup = useGroupAdm && !!groupAdm1 && adm1 === groupAdm1;
  const isAdm2FromGroup = useGroupAdm && !!groupAdm2 && adm2 === groupAdm2;
