export function ResultItemSkeleton() {
    return (
        <div className="h-14 w-full p-3 flex flex-col flex-grow justify-center gap-1">
            <div
                className="bg-neutral-900/10 rounded-full h-4 animate-pulse w-40"
            ></div>
            <div
                className="bg-neutral-900/10 rounded-full h-4 animate-pulse w-56"
            ></div>
        </div>
    );
}
