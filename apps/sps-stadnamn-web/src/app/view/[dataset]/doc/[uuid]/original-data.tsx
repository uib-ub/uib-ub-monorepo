...
export default function OriginalData({rawData}: {rawData: Record<string, any>}) {
    ...
    return (
        ...
        {expanded &&
        <div className='bg-neutral-50 my-2'><div className="flex text-base gap-2 items-center px-4 py-2"><PiWarningFill className='text-xl text-primary-600' aria-label="Advarsel"/>Kan inneholde feil som ikke vil bli rettet</div>
