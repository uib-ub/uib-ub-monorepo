...
export default function ViewLayout({ children, searchSection }: { children: React.ReactNode, searchSection: React.ReactNode } ) {  
    ...
    return (
              <main id="main" className="flex xl:mb-2 xl:mx-2 flex-col xl:grid xl:grid-cols-3 xl:gap-1 scroll-container relative xl:static w-full h-full border-t border-neutral-400 xl:border-none">
                <SearchProvider>
                  {searchSection}
