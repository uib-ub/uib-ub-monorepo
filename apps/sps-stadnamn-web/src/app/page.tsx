...
<main id="main" tabIndex={-1} className="flex flex-col grow-1 gap-14 items-center justify-center pb-24 pt-4 md:pt-8 px-4 w-full flex-grow carta-marina bg-neutral-100 md:bg-transparent">
  ...
  <form className="grid grid-cols-5 md:grid-cols-9 items-center justify-center md:max-w-2xl md:mx-auto gap-3 md:px-8" action="search">
  ...
  { stats && <ul className="text-neutral-900 font-serif small-caps flex items-center justify-center flex-col sm:flex-row gap-6 lg:gap-12">
