...
export const defaultDoc2jsonld = (source: any, children: any) => {
    return {
        ...
        "id": `https://stadnamn.no/uuid/${source.uuid}`,
        "type": "Document",
        "_label": source.label
    };
}
...
export const doc2jsonld = {
    search: (source: any, children: any) => {
        ...
        const places = children.reduce((acc: any, child: any) => {
            ...
            acc[key].documented_in.push({
                "id": `https://stadnamn.no/uuid/${uuid}`,
                "type": "Document"
            })
            return acc
        }, {})
        ...
        const jsonld = {
            ...
            "documented_in": source.children.map((childUuid: any) => ({
                "id": `https://stadnamn.no/uuid/${childUuid}`,
                "type": "Document"
            })),
    ...
    nbas_reykjavik: (source: any, children: any) => {
        const baseObject: any = {
            ...
            "_label": source.label,
            "identifies": {
                "id": "https://stadnamn.no/uuid/" + source.misc.place_uuid,
                "type": "Place",
        ...
        if (source.rawData.X && source.rawData.Y) {
            place["approximated_by"] = {
                "id": "https://stadnamn.no/uuid/" + source.misc.coordinate_uuid,
                "type": "Place",
