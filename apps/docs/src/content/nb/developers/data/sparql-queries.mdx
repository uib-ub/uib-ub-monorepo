...
### Filtrer på en spesifikk klasse og start av signatur
...
### Tell alle egenskaper brukt på en klasse
...
### Få alle klasser, alle brukte egenskaper og en eksempelverdi
...
### Få samme som over, men som json-objekter
...
### Finn alle egenskaper med engelsk språk
...
### Finn alle beskrivelser på no og en, pluss internalNote for Jørgen Grinde-samlingen
...
### Tell innholdet i alle samlinger
...
### Opprett en søk IIIF-samling for ... samlinger
...
### Få objektene med flest egenskaper
...
### Finn alle datatyper per egenskap
...
### Instanser med multiple _bibo:pages_
...
### Sjekk om det er feil i madeAfter og madeBefore
...
WHERE {
  ...
  # Filtrer hvis du bare vil ha resultater hvor made er høyere enn date2
