...
Vercel is the preferred web platform for `chc-monorepo` because of the CDN and serverless/edge functions. Data comes from Sanity.io and local UiB-UB datastores.
