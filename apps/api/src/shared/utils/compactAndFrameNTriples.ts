...
import { cleanDateDatatypes } from '../lib/mappers/la/cleanDateDatatypes';
import { convertLongLatToFloat } from '../lib/mappers/la/convertLongLatToFloat';
...
const compactAndFrameNTriples = async (data: any, context: string, type: string) => {
  ...
  const withFloats = convertLongLatToFloat(fixedDates)
