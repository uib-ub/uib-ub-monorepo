import { getLengthUnit } from '@shared/lib/mappers/la/getLengthUnit';
import { aatCircaType, aatCountOfType, aatHeightType, aatPagesMeasurementUnitType, aatWidthtType } from '@shared/lib/mappers/la/staticMapping';
