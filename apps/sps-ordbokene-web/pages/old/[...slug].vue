<template>
  ...
  <div aria-hidden="true" class="callout" v-if="store.view == 'word' && $route.query.orig"><Icon name="bi:info-circle-fill" size="1.25em" class="mr-3 text-primary mb-0.5"/> {{$t('notifications.redirect')}} <strong>{{store.q}}.</strong></div>
