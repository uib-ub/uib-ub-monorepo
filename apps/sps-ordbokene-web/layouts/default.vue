...
<div>
    ...
    <nav :aria-label="$t('breadcrumbs')" class="ord-container justify-start mt-3 mb-2 pl-3 flex gap-4 flex-wrap" v-if="!['welcome', 'index', 'search', 'article', 'word'].includes($route.name)">
        ...
        <NuxtLink v-else :to="'/' + $i18n.locale"><Icon name="bi:arrow-left" size="1.25em" class="mb-1 mr-1 text-primary"/>{{$t('home')}}</NuxtLink>
