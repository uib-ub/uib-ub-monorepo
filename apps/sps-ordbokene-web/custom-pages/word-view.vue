<template>
    ...
    <div ref="results" v-if="!pending && !error && articles && articles.meta" >
      <client-onlly><div class ="callout" v-if="route.query.orig"><Icon name="bi:info-circle-fill" class="mr-3 mb-1 text-primary"/>{{$t('notifications.redirect')}} <strong>{{route.params.q}}.</strong></div></client-onlly>
