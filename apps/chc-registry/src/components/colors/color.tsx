...
export function Color({ color }: { color: Color }) {
  ...
  return (
    ...
    >
      ...
      <div className="border-ghost after:border-input w-full h-20 shrink-0 rounded-md bg-(--bg) after:rounded-lg md:rounded-lg sm:h-28" />
      <div className="flex flex-0 w-full flex-col items-center justify-center gap-1">
