...
export const Index: Record<string, any> ={
  ...
  "iiif-manifest-demo": {
    ...
    files: [{
      path: "src/registry/uib-ub/items/iiif-manifest/examples/iiif-manifest-demo.tsx",
      content: "import { IIIFManifest } from '../components/iiif-manifest';\n\nexport default function IIFManifestDemo() {\n  // Using a more reliable IIIF manifest for testing\n  const manifestUrl = 'https://api.ub.uib.no/items/ubb-bs-ok-00919?as=iiif';\n\n  return (\n    <div className=\"w-full h-full\">\n      <IIIFManifest iiifContent={manifestUrl} />\n    </div>\n  );\n}\n",
      type: "registry:example",
    }],
    component: React.lazy(() => import("@/registry/uib-ub/items/iiif-manifest/examples/iiif-manifest-demo.tsx")),
    source: "import { IIIFManifest } from '../components/iiif-manifest';\n\nexport default function IIFManifestDemo() {\n  // Using a more reliable IIIF manifest for testing\n  const manifestUrl = 'https://api.ub.uib.no/items/ubb-bs-ok-00919?as=iiif';\n\n  return (\n    <div className=\"w-full h-full\">\n      <IIIFManifest iiifContent={manifestUrl} />\n    </div>\n  );\n}\n",
  },
  "iiif-image": {
    name: "iiif-image",
  ...
  "content-grid": {
    ...
    type: "registry:block",
    files: [{
      path: "src/registry/uib-ub/items/content-grid/components/content-grid.tsx",
  ...
  "content-grid-demo": {
    ...
    type: "registry:example",
    files: [{
      path: "src/registry/uib-ub/items/content-grid/examples/content-grid-demo.tsx",
    ...
    component: React.lazy(() => import("@/registry/uib-ub/items/content-grid/examples/content-grid-demo.tsx")),
  ...
  "button": {
    ...
    type: "registry:block",
    files: [{
      path: "src/registry/uib-ub/items/button/components/button.tsx",
  ...
  "button-demo": {
    ...
    type: "registry:example",
    files: [{
      path: "src/registry/uib-ub/items/button/examples/button-demo.tsx",
      content: "import { Button } from '../components/button';\nimport { PlusIcon } from 'lucide-react';\n\nexport default function ButtonDemo() {\n  return (\n    <div className='flex flex-row flex-wrap gap-5 justify-center'>\n      <Button>Default</Button>\n      <Button variant='destructive'>Destructive</Button>\n      <Button variant='outline'>Outline</Button>\n      <Button variant='secondary'>Secondary</Button>\n      <Button variant='ghost'>Ghost</Button>\n      <Button variant='link'>Link</Button>\n      <Button size='sm'>Small</Button>\n      <Button size='lg'>Large</Button>\n      <Button size='xl'>Extra Large</Button>\n      <Button size='icon'><PlusIcon /></Button>\n    </div>\n  );\n}",
      type: "registry:example",
    }],
    component: React.lazy(() => import("@/registry/uib-ub/items/button/examples/button-demo.tsx")),
