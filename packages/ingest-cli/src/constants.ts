...
export const CHC_SEARCH_ALIAS = "search-chc"

export const CHC_INDICIES = {
  object: 'search-chc-items',
  person: 'search-chc-people',
  place: 'search-chc-places',
  concept: 'search-chc-concepts',
  event: 'search-chc-events',
  group: 'search-chc-groups',
  set: 'search-chc-sets',
  text: 'search-chc-texts',
  visual: 'search-chc-visuals',
