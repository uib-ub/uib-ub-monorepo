...
import { getLAApiType, mapToGeneralClass, Publication } from '../mapToGeneralClass';
import { aatAbstractsType, aatCreationDateDescriptionType, aatDescriptionsType, aatDisplayBiographyType, aatInternalNoteType, aatPaginationStatementType, aatPhysicalConditionsType, aatPhysicalDescriptionType, aatProvenanceStatementsType, aatPublishingType, aatRelatedTextualReferencesType } from '../staticMapping';
import { env } from '../../../../env';
