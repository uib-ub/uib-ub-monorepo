...
export type Specific = "Event" | "Activity";
/**
...
/**
 * _crm:E6\_Event_ or _crm:E7\_Activity_
 * An event (no person carried it out) or activity (some actor was responsible) that occured.
